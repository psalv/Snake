package Queue; /**
 * Queue.Queue.LinkedIterator represents an iterator for a linked list of linear nodes.
 *
 * @author Dr. Lewis
 * @author Dr. Chase
...
public class LinkedIterator<T> implements Iterator<T>
{
    ...
    private PriorityNode<T> current;  // the current position
     ...
     */
    public LinkedIterator(PriorityNode<T> collection, int size)
    {
        current = collection;
        count = size;
    }
